...
- [ ] Fix external `mcp_config.json` entrypoint from `notebooklm_mcp.server` to `notebooklm_tools.mcp.server`
...
- [ ] Group the remaining unrelated dirty files into explicit commit/checkpoint themes before new feature work
