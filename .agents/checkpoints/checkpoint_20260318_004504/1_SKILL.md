...
1. Inspect the relevant files in the current directory.
2. Read `AGENTS.md` and only the skill files needed for the current task.
3. Check whether `research_notes.md`, `implementation_plan.md`, or `task.md` already contain unrelated work.
4. If they do, append a dated section instead of overwriting existing content.
...
- Create files in the project working directory, never in unrelated system directories
- Use a checkpoint before risky edits to system instructions or broad changes
- Log Tier 2 / Tier 3 actions to `agent_audit.log`
