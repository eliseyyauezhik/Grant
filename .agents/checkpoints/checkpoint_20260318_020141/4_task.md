...
- [ ] Update instruction files to allow native `.base` files
- [ ] Configure vault settings in `.obsidian`
- [ ] Add service/source/runbook templates and folders
- [ ] Create service catalog and registry base files
- [ ] Seed the vault with an initial real service record
- [ ] Install and enable `terminal` and `obsidian-kanban`
- [ ] Verify plugin state, base discovery, and daily note configuration
